...
public class Register {
	...
	public void proper_details_should_be_displayed_on_account_success_page() {
	    String properMessageOne = "Your Account Has Been Created!";
	    String properMessageTwo = "Congratulations! Your new account has been successfully created!";
	    String properMessageThree = "You can now take advantage of member privileges to enhance your online shopping experience with us.";
	    String properMessageFour = "If you have ANY questions about the operation of this online shop, please e-mail the store owner.";
	    String properMessageFive = "A confirmation has been sent to the provided e-mail address. If you have not received it within the hour, please contact us.";
	    
	    Assert.assertEquals(properMessageOne,driver.findElement(By.xpath("//div[@id='content']/h1")).getText());
	    Assert.assertEquals(properMessageTwo,driver.findElement(By.xpath("(//div[@id='content']/p)[1]")).getText());
	    Assert.assertEquals(properMessageThree,driver.findElement(By.xpath("(//div[@id='content']/p)[2]")).getText());
	    Assert.assertEquals(properMessageFour,driver.findElement(By.xpath("(//div[@id='content']/p)[3]")).getText());
	    Assert.assertEquals(properMessageFive,driver.findElement(By.xpath("(//div[@id='content']/p)[4]")).getText());
	}
	...
	public void user_should_be_navigated_to_my_account_page() {
	    Assert.assertTrue(driver.findElement(By.xpath("(//div[@id='content']/h2)[1]")).isDisplayed());
	}
